...
export const RouteCard: React.FC<RouteCardProps> = ({ route }) => {
  ...
  return (
    <Card className="border-slate-200 bg-white shadow-sm">
      ...
      {/* Metric summary */}
      <div className="grid grid-cols-3 gap-3 my-4 p-3.5 bg-slate-50 rounded-xl border border-slate-200 text-center">
        <div>
          ...
          <div key={stop.id} className="flex items-start gap-3 relative">
            ...
            <div className="flex-1 pb-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-slate-500 font-mono">{stop.timestamp}</span>
              </div>
