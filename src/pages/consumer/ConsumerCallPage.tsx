  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto animate-in fade-in duration-300">
      ...
      <div className="bg-slate-900 border border-slate-700/80 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden text-center">
        ...
        <div className="mt-6 p-4 bg-slate-950/70 border border-slate-800 rounded-2xl text-left space-y-3">
          ...
          <div className="space-y-2 text-xs">
            ...
            <div className="p-2 rounded-lg bg-slate-900 border border-slate-800">
              <span className="font-bold text-cyan-400">Buyer: </span>
              <span className="text-slate-300">
            ...
            <div className="p-2 rounded-lg bg-emerald-950/40 border border-emerald-800/40">
              <span className="font-bold text-emerald-400">AI Assistant: </span>
