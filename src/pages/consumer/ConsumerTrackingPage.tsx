...
export const ConsumerTrackingPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-black text-white flex items-center gap-2">
            ...
            <span className="text-xs px-2.5 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 font-semibold animate-pulse">
              ● Live Transit
            </span>
          </h1>
          <p className="text-slate-400 text-sm mt-1">
            Tracking order <span className="font-mono text-emerald-400">{activeOrder.id}</span> with real-time temperature telemetry.
          </p>
        </div>
      ...
      <Card className="p-6 border-slate-700/80 bg-slate-900/90 relative overflow-hidden">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-4 border-b border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-white text-base">Pilot: Suresh Verma</h3>
              <p className="text-xs text-slate-400">EV Reefer • UP 14 BT 9942 • ETA 25 mins</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-800 border border-slate-700 text-xs">
              ...
              <span className="text-slate-300">Chamber Temp: </span>
              <span className="font-bold text-cyan-400">5.2°C (Optimal)</span>
            </div>
